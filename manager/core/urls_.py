...
urlpatterns = [
    ...
    path('consumable_groups/', views.consumable_group_list, name='consumable_group_list'),
    path('consumable_group/create/', views.consumable_group_create, name='consumable_group_create'),
    path('consumable_group/<int:group_id>/', views.consumable_group_detail, name='consumable_group_detail'),
    path('consumable_group/delete/<int:group_id>/', views.consumable_group_delete, name='consumable_group_delete'),
    path('norm_consumable/create/<int:group_id>/', views.create_norm_consumable, name='norm_consumable_create'),
    path('norm_consumable/edit/<int:group_id>/', views.norm_consumable_edit, name='norm_consumable_edit'),
    path('norm_consumable/update/<int:norm_id>/', views.norm_consumable_update, name='norm_consumable_update'),
    path('norm_consumable/delete/<int:norm_id>/', views.norm_consumable_delete, name='norm_consumable_delete'),
    path('employees/<int:employee_id>/consumables/create/', views.create_consumable_issue, name='create_consumable_issue'),
]
